...
The kernels can be applied separately to the input image, to produce separate measurements of the gradient component in each orientation (call these G x and G y).
